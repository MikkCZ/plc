...
* TOC
{:toc .icons-flex .wider}

{:.icons-flex}
- [<i class="fas fa-download"></i> Linux mne zaujal a chci ho vyzkoušet]({% link _pages/kde-ziskat.md %})

## <i class="fas fa-battery-full"></i> Moderní
{:#moderni}
...
Mezi nejpoužívanější a nejvyspělejší grafické prostředí patří GNOME, KDE, Xfce, Cinnamon nebo MATE. Nemusíte se ale bát žádného složitého výběru. Grafické prostředí je vždy součástí každé [distribuce]({% link _pages/kde-ziskat.md %}) pro běžné uživatele. Navíc jako je možné měnit celý Linux, je možné měnit i jeho vzhled. Přeneste si třeba barvy svého pokoje i na monitor.

## <i class="fas fa-shield-alt"></i> Bezpečný
{:#bezpecny}
...
## <i class="fas fa-user"></i> Zcela ovladatelný
{:#ovladatelny}
...
Vždy si můžete [vybrat distribuci]({% link _pages/kde-ziskat.md %}), software, který chcete používat, filosofii, která vám vyhovuje nejlépe, stejně jako vzhled a prostředí, ve kterém chcete pracovat. Můžete si vybrat práci se systémem na nejrůznějších úrovních od [začátečníka](http://bbs.cvut.cz/~covex/linux/newbie.html) až po [pokročilé](http://bbs.cvut.cz/~covex/linux/kouzlo_cmdline.html).
...
## <i class="far fa-window-restore"></i> Velké množství aplikací
...
Pokud hledáte vhodnou náhradu aplikací zkuste se podívat do naší [tabulky ekvivalentních aplikací]({% link _pages/ekvivalenty.md %}).

## <i class="fas fa-globe"></i> Internet samozřejmostí
Přístup k internetu je samozřejmostí a u Linuxu je tomu nejinak. Můžete používat na Linuxu asi nejrozšířenější Firefox nebo další z [dostupných webových prohlížečů]({% link _pages/ekvivalenty.md %}#internet), které znáte z Windows a jiných systémů. Není nic jednoduššího, než si svá nastavení, hesla a záložky sesynchronizovat nebo [převést do Linuxu]({% link _pages/ekvivalenty.md %}).
...
## <i class="fas fa-film"></i> Multimédia
Měli jste někdy problémy s přehráváním nějakého filmu? Chyběl vám kodek, nebo prostě přehrávač odmítl daný formát přehrát? Pak byste měli zkusit svobodný [VLC media Player](https://www.videolan.org/) nebo některý další z řady [přehrávačů]({% link _pages/ekvivalenty.md %}#video).

Linux nabízí nespočet [hudebních přehrávačů]({% link _pages/ekvivalenty.md %}#hudba), které se vám mohou postarat o organizaci hudební kolekce. Podobně vám další aplikace pomohou s utříděním všech vašich fotografií. Stačí vybrat ve správci softwaru z dostupných programů ten, který vám nejlépe vyhovuje, nebo použijte ten, který linuxová [distribuce]({% link _pages/kde-ziskat.md %}) už obsahuje.
...
## <i class="fas fa-wrench"></i> Variabilní a přizpůsobitelný
...
## <i class="fas fa-network-wired"></i> Vzdálená správa
...
## <i class="far fa-life-ring"></i> Kvalifikovaná podpora a dokumentace
{:#podpora}
...
## ![]({{ 'img/layout/czech-flag.svg' | relative_url }}){:style="border: 1px solid #ddd"} Dostupný v češtině
...
## <i class="fas fa-piggy-bank"></i> Pro všechny zdarma
V podstatě **všechny linuxové distribuce jsou k dispozici zdarma**, protože se jedná o **svobodný software**. Nejsnadněji jsou dostupné [ke stažení z internetu]({% link _pages/kde-ziskat.md %}). Můžete si však i [objednat](https://www.linuxmarket.cz/) USB flash disk nebo DVD až domů, včetně různých příruček.
