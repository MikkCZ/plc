...
| Víceúčelové textové editory | PSPad <br> Notepad++ <br> [jEdit](http://www.jedit.org/){:.mp} | [Bluefish](http://bluefish.openoffice.nl/){:.mp} <br> [Geany](https://www.geany.org/){:.mp} <br> [Kate](https://kate-editor.org/) <br> [Gedit](https://wiki.gnome.org/Apps/Gedit) <br> [Vim](https://www.vim.org/) <br> [Emacs](https://www.gnu.org/software/emacs/) <br> [Scribes](http://scribes.sourceforge.net/) <br> Mcedit (z [mc](http://www.ibiblio.org/mc/)) <br> [jEdit](http://www.jedit.org/){:.mp} |
| HEX-editor | HxD <br> PSPad <br> Notepad++ (+ plugin) <br> Hex Editor <br> [Cheat Engine](https://cheatengine.org/){:.mp} | [Cheat Engine](https://cheatengine.org/){:.mp} <br> [hexedit](http://hexedit.sourceforge.net/) (konsole) <br> [Emacs](https://www.gnu.org/software/emacs/) <br> [GHex](https://directory.fsf.org/wiki/Ghex) |
